package com.ashehata.brightskies_task.modules.user.di

import com.ashehata.brightskies_task.modules.user.data.local.UserLocalDataSource
import com.ashehata.brightskies_task.modules.user.data.local.UserLocalDataSourceImpl
import com.ashehata.brightskies_task.modules.user.data.repository.UserRepositoryImpl
